...
const Navbar = () => {
  ...
  const [showBackgroundMenu, setShowBackground] = useState(false);
  ...
  return (
    <nav className="fixed z-40 w-full">
      <div
        className={`flex flex-row items-center bg-zinc-900 bg-opacity-90 px-4 py-6 transition duration-500 md:px-16 ${
